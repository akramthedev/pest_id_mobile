...
const AlertMessage2 = ({ type, message, visible }) => {
...
export const AlertSuccess = ({ message, visible }) => {
  return <AlertMessage2 type="success" message={message} visible={visible} />;
};

// Error Alert
export const AlertError = ({ message, visible }) => {
  return <AlertMessage2 type="error" message={message} visible={visible} />;
};
